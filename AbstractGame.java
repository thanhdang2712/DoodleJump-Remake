...
public abstract class AbstractGame {
    ...
    protected void handleMouseClick(){
      ...
      if (click != null){ //ensure a mouse click occurred
        ...
        if (getSplashImage() != null){
            if (clickX <= 550 && clickX >= 300 && clickY <= 640 && clickY >= 500) {
                setSplashImage(null);
            }
        }
      }
    ...
    //returns the mouse event for any child classes overriding this method
    }
    ...
    public Color getBackgroundColor(Color bgColor){ //is this a bug?
    ...
    protected Entity checkCollision(Entity toCheck){
        for (Entity e : displayList){
            ...
            //Is this equal operator sufficient?
