...
public class GameWindow extends JComponent implements KeyListener, MouseListener{
    ...
    private static final int DEFAULT_GAME_SPEED = 80;
    ...
    //Linked to the ArrayList of the associated AbstractGame object
    ...
    public GameWindow(int windowWidth, int windowHeight, ArrayList<Entity> displayList){
      this.displayList = displayList; //Link this displayList to the respective AbstractGame
    ...
    private void initLogic(){
        ...
        for (int key : AbstractGame.MOVEMENT_KEYS)
    ...
    private void initWindow(int windowWidth, int windowHeight){                
        window = new JFrame("Save The Doodle!");
    ...
    //Called by AbstractGame to redraw the window and all of the Entities in it   
    public void refresh(){
      this.repaint();
...
g.setColor(getForeground());
    ...
    public ArrayList<Integer> getKeysPressed(){
      ...
      for (Integer key : keysCurrentlyPressed){
